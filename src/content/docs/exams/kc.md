...
2. **Q:** What is the role of the motherboard in a computer system?
   <details>
   <summary>Answer</summary>
   A: It connects all the components …
   </details>

3. **Q:** Which components are physical of a computer system?
   <details>
   <summary>Answer</summary>
   A: Motherboard, Network Card.
   </details>

4. **Q:** Which Statements describe random Access Memory?
   <details>
   <summary>Answer</summary>
   A: It holds data temporarily & It can be accessed quickly.
   </details>
...
2. **Q:** Which Statements describe the benefits of virtualization?
   <details>
   <summary>Answer</summary>
   A: Multiple virtual machines can be run on the single physical Computer & virtual machines can reduce the amount of wasted computing resources from underutilized servers.
   </details>
...
4. **Q:** What are the responsibilities of the database administrator? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: Configure access to the data and Secure the data
   </details>
...
1. **Q:** Which statement describes cloud computing?
   <details>
   <summary>Answer</summary>
   A: It delivers information technology (IT) resources on demand.
   </details>

2. **Q:** Which scenario is an example of software as a service (SaaS) in cloud computing?
   <details>
   <summary>Answer</summary>
   A: The third-party vendor manages the procurement of resources and the application. The developer is responsible for the application content.
   </details>
...
1. **Q:** What are benefits of trading fixed expense for variable expense? (Select TWO.)
   <details>
   <summary>Answer</summary>
   A: Paying only when computing resources are consumed and Paying for only how much is consumed.
   </details>

2. **Q:** What does the concept of massive economies of scale mean in terms of cloud computing?
   <details>
   <summary>Answer</summary>
   A: Savings can be passed on to customers when more customers use AWS.
   </details>
...
4. **Q:** What is a benefit of developing in a cloud environment?
   <details>
   <summary>Answer</summary>
   A: The time needed to access computing resources is reduced.
   </details>
...
2. **Q:** Which statement describes AWS?
   <details>
   <summary>Answer</summary>
   A: AWS is a secure cloud services provider that offers many services to help businesses scale and grow.
   </details>
...
4. **Q:** Which tools can customers use to create and manage resources in the AWS Cloud? (Select THREE.)
   <details>
   <summary>Answer</summary>
   A: AWS software development kits (SDKs), AWS CLI, and AWS Management Console.
   </details>

5. **Q:** Which resource does the AWS documentation provide?
   <details>
   <summary>Answer</summary>
...
1. **Q:** Which types of data transfer are free for Amazon S3? (Select TWO.)
   <details>
   <summary>Answer</summary>
   A: Outbound data transfer from Amazon S3 to Amazon CloudFront in the same Region & Inbound data transfer from the internet to Amazon S3
   </details>

2. **Q:** Which payment options are available for most Amazon EC2 Reserved Instances? (Select THREE.)
   <details>
   <summary>Answer</summary>
   A: No Upfront payment, All Upfront payment, Partial Upfront payment
   </details>

3. **Q:** Which statements describe the benefits of using the AWS Pricing Calculator? (Select THREE.)
   <details>
   <summary>Answer</summary>
   A: It gives customers the ability to create estimates for their AWS use cases. & It can help identify opportunities for cost reduction. & It estimates monthly services costs.
   </details>

4. **Q:** Which categories are fundamental drivers of cost with AWS? (Select THREE.)
   <details>
   <summary>Answer</summary>
   A: Storage, Data transfer, Compute
   </details>
...
2. **Q:** What is an Availability Zone?
   <details>
   <summary>Answer</summary>
   A: One or more data centers that are built with fault isolation
   </details>

3. **Q:** What is an AWS Region?
   <details>
   <summary>Answer</summary>
   A: A geographical area in the world.
   </details>

4. **Q:** How many Availability Zones are in an AWS Region?
   <details>
   <summary>Answer</summary>
   A: A minimum of three (!!!See problem description below!)
   </details>
...
1. **Q:** Which services are in the AWS storage category?
   <details>
   <summary>Answer</summary>
   A: Amazon Elastic File System (Amazon EFS) & Amazon S3
   </details>
...
3. **Q:** Which of the following are AWS service categories? (Select TWO.)
   <details>
   <summary>Answer</summary>
   A: Security, Identity, and Compliance & Compute
   </details>
...
3. **Q:** Which task is the customer responsible for according to the AWS shared responsibility model?
   <details>
   <summary>Answer</summary>
   A: Ensuring that users have entered a user ID and password before they use an application
   </details>
...
4. **Q:** Which action incurs a cost when using Amazon S3?
   <details>
   <summary>Answer</summary>
   A: Transferring data out to other AWS Regions
   </details>
...
1. **Q:** Which statement describes the Amazon EC2 service?
   <details>
   <summary>Answer</summary>
   A: It provides virtual machines that run on AWS.
   </details>
...
4. **Q:** Which of the following statements are true about security groups for Amazon EC2 instances? (Select TWO.)
   <details>
   <summary>Answer</summary>
   A: They allow all outbound traffic by default and They support adding rules that allow traffic from specified sources.
   </details>

5. **Q:** A company needs to run an application that is fault tolerant and tolerates interruptions on AWS. Which pricing model would best fit their requirements and help them lower costs as much as possible?
   <details>
   <summary>Answer</summary>
   A: Spot Instances.
   </details>
...
3. **Q:** What is a Linux daemon?
   <details>
   <summary>Answer</summary>
   A: A program that provides a service and runs in the background
   </details>
...
1. **Q:** Which statements apply to setting user passwords? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: Users can reset their own passwords. Passwords are set with the passwd command.
   </details>

2. **Q:** Which permission does a standard user have? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: Control any files that the user owns. Access any files that the user has permissions for.
   </details>
...
4. **Q:** Which command allows you to add a user to a group?
   <details>
   <summary>Answer</summary>
   A: usermod
   </details>
...
1. **Q:** Which statements about Linux file names are true? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: Extensions are optional. File names are case sensitive.
   </details>
...
4. **Q:** Which statement about symbolic links is true?
   <details>
   <summary>Answer</summary>
   A: Symbolic links point to a hard link, instead of the actual file.
   </details>
...
5. **Q:** Which statement reflects the principle of least privilege?
   <details>
   <summary>Answer</summary>
   A: Give the least number of users the least amount of file access first, and grant more permissions only when the user has a need.
   </details>
...
3. **Q:** A developer is troubleshooting an issue and wants to check the log file /var/log/secure.log for any failures. Which command syntax is available to find if the log file contains the word 'fail'?
   <details>
   <summary>Answer</summary>
   A: grep fail /var/log/secure.log
   </details>

4. **Q:** What is the *sed* command?
   <details>
   <summary>Answer</summary>
   A: A non-interactive text editor
   </details>
...
2. **Q:** Which commands list the process IDs (PIDs) for the running processes on a Linux host? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: pidof ps
   </details>
...
1. **Q:** What is a variable?
   <details>
   <summary>Answer</summary>
   A: A variable is a value that’s substituted into the script or command
   </details>
...
1. **Q:** Why might an administrator create a Bash shell script? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: To ensure that a task runs correctly and consistently. To automate a repetitive task
   </details>
...
3. **Q:** Which statements about a log file are correct? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: A log file can help troubleshoot issues. The size and number of log files on a server can quickly increase.
   </details>
...
5. **Q:** A Linux systems administrator must perform security audits, which is a routine administration task. During a security audit, the administrator must determine which recent users have logged in to the system. Which command enables the administrator to show the users who logged in recently?
   <details>
   <summary>Answer</summary>
   A: lastlog
   </details>
...
2. **Q:** What is the role of a server in the client-server computing model?
   <details>
   <summary>Answer</summary>
   A: The server responds to a request from the client.
   </details>
...
4. **Q:** Which statement describes a Media Access Control (MAC) address and how it’s used by a network interface card (NIC)?
   <details>
   <summary>Answer</summary>
   A: It is a unique physical identifier that’s assigned by the manufacturer. The NIC uses it to identify data about the sender and the receiver.
   </details>
...
1. **Q:** Which statement accurately describes the function of a local area network (LAN) and wide area network (WAN)?
   <details>
   <summary>Answer</summary>
   A: A LAN connects nodes and hosts within a geographically limited area. A WAN connects multiple LANs to create a more expansive network that can cover large geographical areas, such as cities.
   </details>
...
4. **Q:** Which statement describes a connectionless protocol?
   <details>
   <summary>Answer</summary>
   A: It sends a message to the destination without ensuring that the destination is available.
   </details>
...
3. **Q:** A network engineer wants to separate a network from the internet and from other networks. Which IP address type should the engineer use?
   <details>
   <summary>Answer</summary>
...
1. **Q:** Which statement describes Amazon Virtual Private Cloud (Amazon VPC)?
   <details>
   <summary>Answer</summary>
   A: It enables you to create a private network in the AWS Cloud
   </details>
...
4. **Q:** What is the purpose of a route table?
   <details>
   <summary>Answer</summary>
   A: It determines where network traffic is directed within the virtual private cloud (VPC)
   </details>
...
1. **Q:** What are some reasons for creating a subnet? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: To reduce network traffic. To divide a network into smaller, more efficient subnets.
   </details>
...
2. **Q:** Which statements regarding HTTP are true? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: The default port number for HTTP is 80 HTTP is a client-server protocol.
   </details>

3. **Q:** Which messages are included in a TCP handshake? (Select THREE)
   <details>
   <summary>Answer</summary>
   A: SYN/ACK Acknowledge (ACK) Synchronize (SYN)
   </details>
...
5. **Q:** Which remote desktop protocol is popular with remote support technicians and is a proprietary Microsoft protocol?
   <details>
   <summary>Answer</summary>
...
2. **Q:** Which communication protocols does AWS IoT Core use to communicate with devices? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: Hypertext Transfer Protocol Secure (HTTPS) Message Queuing Telemetry Transport (MQTT)
   </details>

3. **Q:** What is the goal of the Internet of Things (IoT)?
   <details>
   <summary>Answer</summary>
   A: Make devices that can connect to the internet to report data, be monitored, or be remotely controlled.
   </details>

4. **Q:** Which solutions facilitate enterprise mobility for businesses that support remote-working options? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: Bring your own device (BYOD) Mobile device management (MDM)
   </details>
...
1. **Q:** What is the role of confidentiality in the confidentiality, integrity, and availability (CIA) triad?
   <details>
   <summary>Answer</summary>
   A: It ensures that resources are accessed by only authorized users.
   </details>
...
1. **Q:** Which of the following tasks are a part of the prevention phase of the life cycle? (Select THREE.)
   <details>
   <summary>Answer</summary>
   A: Implement countermeasures. Assess asset vulnerability. Identify assets to be protected.
   </details>
...
3. **Q:** What is the benefit of using a layered security prevention strategy to protect a valuable asset?
   <details>
   <summary>Answer</summary>
   A: The valuable asset is protected by multiple layers of different types of security measures.
   </details>

4. **Q:** Which of the following are types of security prevention measures? (Select THREE.)
   <details>
   <summary>Answer</summary>
   A: Data security controls Network hardening Systems hardening
   </details>
...
3. **Q:** Which statement fully describes the purpose of a firewall?
   <details>
   <summary>Answer</summary>
   A: It filters inbound and outbound packets on a network
   </details>

4. **Q:** Which of the following is a benefit of network segmentation? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: It allows administrators to apply different security controls to different parts of a network. It improves network traffic performance.
   </details>
...
1. **Q:** What is the primary goal of systems hardening?
   <details>
   <summary>Answer</summary>
   A: To minimize security risks by reducing the set of vulnerabilities that are exposed by a system.
   </details>

2. **Q:** What is the security baseline?
   <details>
   <summary>Answer</summary>
   A: A starting point for determining what to secure and how to secure a system.
   </details>

3. **Q:** Which task helps to harden a system?
   <details>
   <summary>Answer</summary>
   A: Applying patches regularly
   </details>

4. **Q:** How does physical security contribute to systems hardening?
   <details>
   <summary>Answer</summary>
   A: Restricts physical access to facilities through biometrics, CCTV, and so on.
   </details>
...
2. **Q:** Which of the following is an advantage of symmetric encryption?
   <details>
   <summary>Answer</summary>
   A: Its key is a shared secret between the sender and the receiver.
   </details>
...
2. **Q:** What is a digital certificate?
   <details>
   <summary>Answer</summary>
   A: An electronic credential that is used to represent the identity of an individual, computer, or other entity
   </details>
...
1. **Q:** What is the goal of authorization in identity management?
   <details>
   <summary>Answer</summary>
   A: Determining a user’s permissions.
   </details>
...
1. **Q:** What is the goal of identity management?
   <details>
   <summary>Answer</summary>
   A: Administer users and their access permissions.
   </details>
...
4. **Q:** Where do you define the actions that may or may not be performed by a user?
   <details>
   <summary>Answer</summary>
   A: In a policy document attached to the user.
   </details>
...
1. **Q:** What is AWS CloudTrail?
   <details>
   <summary>Answer</summary>
   A: A web service that logs records user and API activity in Amazon Web Services (AWS) events.
   </details>

2. **Q:** What are the key benefits of AWS CloudTrail? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: It simplifies compliance audits by recording activities and events into log files. It provides visibility by recording user and resource activities.
   </details>

3. **Q:** Which types of information do AWS CloudTrail events capture when a user performs a service request? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: The IP address where the request originated The user who performed the request
   </details>

4. **Q:** Which statements are best practices for working with AWS CloudTrail? (Select TWO)
   <details>
   <summary>Answer</summary>
   A: Turn on file integrity validation for CloudTrail. Aggregate log files into a single Amazon Simple Storage Service (Amazon S3) bucket.
   </details>
